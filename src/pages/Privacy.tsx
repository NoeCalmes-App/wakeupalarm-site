...
export default function Privacy() {
  ...
  const content = {
    ...
    fr: {
      ...
      lastUpdate: 'Dernière mise à jour : 6 décembre 2025',
      sections: [
        {
          title: '1. PRÉAMBULE',
          paragraphs: [
            'La présente Politique de Confidentialité a pour objet d\'informer les utilisateurs de l\'application mobile WakeUp Alarme (ci-après l\'« Application ») sur la manière dont leurs données personnelles sont collectées, utilisées et protégées.',
            'WakeUp Alarme accorde une importance particulière au respect de la vie privée et traite les données personnelles conformément au Règlement Général sur la Protection des Données (UE) 2016/679 (« RGPD ») et à la législation française applicable.'
          ]
        },
        {
        ...
        },
        {
          ...
          list: [
            ...
            'Données de compte : préférences utilisateur, paramètres d\'alarme,',
            'Données de paiement : informations liées aux abonnements (sans accès ni stockage des données bancaires),',
            'Données Spotify : informations nécessaires à l\'accès aux extraits audio (aucune modification du compte Spotify),',
            'Données issues de la caméra ou du stockage local, uniquement lorsque cela est requis pour les missions,',
        ...
        },
        {
          ...
          list: [
            ...
            'Déclencher les alarmes et valider la réalisation des missions,',
            'Gérer les comptes utilisateurs,',
            'Gérer les abonnements et les paiements,',
            'Permettre l\'intégration de services tiers (Spotify, Apple),',
        ...
        },
        {
          ...
          list: [
            'Le consentement de l\'Utilisateur (notifications, caméra, Spotify),',
